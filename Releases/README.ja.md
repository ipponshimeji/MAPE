...
### 2018/05/21 [1.0.21.0 (beta)](MAPE_1.0.21.0_Windows.zip) 

sha256ハッシュ: 87C253040A7D415660E3C804827E9048F628F5639D9648352CC6FA2512C099D8

* 「実際のプロキシ」を明に指定する場合（自動検出しない場合）、「実際のプロキシ」として自動構成スクリプト（.pacファイル）も指定できるようにしました。（Issue #4）
...
* 特定条件下で通信を切断して502を返してしまうバグがあったので、修正しました。


### 2017/09/19 ~~1.0.18.0 (beta)~~

sha256ハッシュ: D2D493EB7D3C36175D49F94476D1721B711612013AD36453CF5A02A338109BD5

* バグがあったので置き換えました。1.0.19.0以降を使ってください。
* レスポンス処理の効率化。
